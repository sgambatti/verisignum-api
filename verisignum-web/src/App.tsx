...
// ==========================================
const STRIPE_PRICE_ID = 'COLE_O_SEU_PRICE_ID_AQUI'; 
...
export default function App() {
  ...
  // --- Ecrã de Carregamento Inicial (Evita flashes da tela) ---
  if (isInitialLoading) {
    return (
  ...
  // --- Painel de Controlo Principal (Apenas para Contas Ativas) ---
  return (
